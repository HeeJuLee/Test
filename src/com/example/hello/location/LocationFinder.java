...
public class LocationFinder {
    ...
    public void find() {
        if(!mGpsEnabled && !mNetworkEnabled) { 
        	Toast.makeText(mContext, R.string.not_support_gps_network, Toast.LENGTH_LONG).show();
        	return;
        }
        ...
        Location location = requestUpdatesFromProvider(providerName, R.string.not_support_gps_network);
        return;
    }
