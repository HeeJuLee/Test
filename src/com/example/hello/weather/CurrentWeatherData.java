...
import com.example.hello.xmlparser.CurrentWeatherXmlParser;
import com.example.hello.xmlparser.CurrentWeatherXmlParser.CurrentWeatherXmlData;
...
public class CurrentWeatherData {
	...
	protected int getResourceID() {
		int icon = getIcon();
		return determineResourceByIcon(icon);
	}
}
